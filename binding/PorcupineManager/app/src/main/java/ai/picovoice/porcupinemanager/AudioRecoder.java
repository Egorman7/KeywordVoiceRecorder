 ...
 */
class AudioRecorder {
    public interface OnBufferObtainedCallback{
        public void obtainBuffer(short[] buffer);
    }
    public OnBufferObtainedCallback callback = null;
